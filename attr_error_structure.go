// Package sphinx implements the Sphinx onion routing packet format along with
// the attributable error scheme used to propagate and verify failure messages
// on the return path of a route.
package sphinx
...
func (o *AttrErrorStructure) totalHmacs() int {
	// This is the triangular number of hopCount (sum of 1..hopCount).
	//
	//nolint:mnd
